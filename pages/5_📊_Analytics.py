...
st.caption("Creator performance, content topics, gaps, and trends")
...
with tab1:
    ...
    df_lb = get_creator_leaderboard(30)
    if df_lb.empty:
...
with tab4:
    ...
    df_top = get_top_posts(topic_sel, 50)
    if df_top.empty:
...
with tab5:
    ...
    df_ht = get_hashtag_intelligence(40)
    if df_ht.empty:
